<div class="displayResume">
  <div class="container-fluid h-100">
    <div class="row h-100">
      ...
      <!-- COLONNE GAUCHE -->
      <div class="col-4 border-end px-4 py-5 text-center bg-light">

        <!-- Photo -->
        <div class="mx-auto mb-5" style="width:140px; height:140px;">
          <img
            class="img-fluid rounded-circle pdp-preview"
            alt="Photo de profil"
        ...
        <div class="mb-5 text-start">
          <h6 class="text-uppercase text-primary mb-3">Contact</h6>
          <ul class="list-unstyled small mb-0">
            <li class="mail-preview mb-1"></li>
        ...
        <div class="text-start">
          <h6 class="text-uppercase text-primary mb-3">Centres d’intérêt</h6>
          <div class="hobbies-preview small d-flex flex-column gap-2"></div>
        </div>
